<template>
    ...
    <div class="taskinfo">
        ...
        <div class="taskinfo-content">
            ...
            <div class="task-endTime">结束时间：{{taskinfo.endTime}}</div>
        </div>
        <div class="chain"></div>
        <div class="task-subTaskInfo">
            ...
            <div class="receive-list">
                <div class="receive-list-item-no" v-if="aa.length==0">暂无完成</div>
                <!-- <div class="receive-list-item" v-if="taskinfo.subTaskInfo.receiveUser" v-for="(item,index) in taskinfo.subTaskInfo.receiveUser" >
...
export default {
    ...
    created(){
        ...
        let baseUrl='http://192.168.0.133:8099/projectTask/projectTaskInfo'
        let id='?id='+type.id;
        ...
        axios({
            ...
            if(Response.status==200){
                ...
                this.aa=Response.data.data.subTaskInfo.receiveUser;
                console.log(this.aa.length);
                // console.dir(this.taskinfo.subTaskInfo);
                // console.dir(this.taskinfo.subTaskInfo.receiveNum);
                // console.dir(this.taskinfo.subTaskInfo.receiveUser.length);
                // console.dir(this.taskinfo.subTaskInfo.receivePrice);
